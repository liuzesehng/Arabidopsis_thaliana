...
awk 'NR==FNR {a[$1]; next} $2 in a' 10C/10C.greenyellow_module_genes.txt Ath_TF_list.txt > 10C/TF_in_module.txt
sort -k2,2 10C/TF_in_module.txt -o 10C/TF_in_module.txt
awk 'NR==FNR {a[$1]; next} $2 in a' 16C/16C.pink_module_genes.txt Ath_TF_list.txt > 16C/TF_in_module.txt
sort -k2,2 16C/TF_in_module.txt -o 16C/TF_in_module.txt
awk 'NR==FNR {a[$1]; next} $2 in a' 22C/22C.red_module_genes.txt Ath_TF_list.txt > 22C/TF_in_module.txt
sort -k2,2 22C/TF_in_module.txt -o 22C/TF_in_module.txt

awk 'NR==FNR {a[$1]; next} $2 in a' total/negative_brown_module_genes.txt Ath_TF_list.txt > total/TF_negative_in_module.txt
sort -k2,2 total/TF_negative_in_module.txt -o total/TF_negative_in_module.txt
awk 'NR==FNR {a[$1]; next} $2 in a' 10C/10C.negative_green_module_genes.txt Ath_TF_list.txt > 10C/TF_negative_in_module.txt
sort -k2,2 10C/TF_negative_in_module.txt -o 10C/TF_negative_in_module.txt
awk 'NR==FNR {a[$1]; next} $2 in a' 16C/16C.negative_salmon_module_genes.txt Ath_TF_list.txt > 16C/TF_negative_in_module.txt
sort -k2,2 16C/TF_negative_in_module.txt -o 16C/TF_negative_in_module.txt
awk 'NR==FNR {a[$1]; next} $2 in a' 22C/22C.negative_magenta_module_genes.txt Ath_TF_list.txt > 22C/TF_negative_in_module.txt
...
awk 'NR==FNR {a[$1]; next} $1 in a' total/negative_brown_module_genes.txt all.fimo.out.filt > total/gene.TF_negative_ids.txt
