...
do    
    ...
    if [ ${#name_array[@]} -ge 2 ]; then
        ...
        # 处理 CG, CHG, CHH promoter、terminator 数据
        rca_CG_promoter=$(awk -v var="$name2" '$1 == var".CG.rca_promoter" {print $2}' ../meth/methylation_count.txt)
        rca_CG=$(awk -v var="$name2" '$1 == var".CG.rca" {print $2}' ../meth/methylation_count.txt)
        rca_CG_terminator=$(awk -v var="$name2" '$1 == var".CG.rca_terminator" {print $2}' ../meth/methylation_count.txt)

        rca_CHG_promoter=$(awk -v var="$name2" '$1 == var".CHG.rca_promoter" {print $2}' ../meth/methylation_count.txt)
        rca_CHG=$(awk -v var="$name2" '$1 == var".CHG.rca" {print $2}' ../meth/methylation_count.txt)
        rca_CHG_terminator=$(awk -v var="$name2" '$1 == var".CHG.rca_terminator" {print $2}' ../meth/methylation_count.txt)

        rca_CHH_promoter=$(awk -v var="$name2" '$1 == var".CHH.rca_promoter" {print $2}' ../meth/methylation_count.txt)
        rca_CHH=$(awk -v var="$name2" '$1 == var".CHH.rca" {print $2}' ../meth/methylation_count.txt)
        rca_CHH_terminator=$(awk -v var="$name2" '$1 == var".CHH.rca_terminator" {print $2}' ../meth/methylation_count.txt)

        col1+=($rca_CG_promoter $rca_CG $rca_CG_terminator $rca_CHG_promoter $rca_CHG $rca_CHG_terminator $rca_CHH_promoter $rca_CHH $rca_CHH_terminator)
        col2+=($rca_CG_promoter $rca_CG $rca_CG_terminator $rca_CHG_promoter $rca_CHG $rca_CHG_terminator $rca_CHH_promoter $rca_CHH $rca_CHH_terminator)
        ...
        col+=($rca_CG_promoter $rca_CG $rca_CG_terminator $rca_CHG_promoter $rca_CHG $rca_CHG_terminator $rca_CHH_promoter $rca_CHH $rca_CHH_terminator)
