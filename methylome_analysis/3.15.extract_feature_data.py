...
def process_feature_category(category_name, feature_file, data_base_dir, output_dir):
    ...
    # 读取特征文件（根据文件扩展名选择不同的读取方法）
    if feature_file.endswith('.txt'):
        features = extract_features_from_file(feature_file)
    else:
...
提取的特征类别:
1. A_TPM
   - {output_dir}/A_TPM/A_TPM_snp_data.csv
   - {output_dir}/A_TPM/A_TPM_CG_data.csv
   - {output_dir}/A_TPM/A_TPM_CHG_data.csv
   - {output_dir}/A_TPM/A_TPM_CHH_data.csv

2. B_TPM
   - {output_dir}/B_TPM/B_TPM_snp_data.csv
   - {output_dir}/B_TPM/B_TPM_CG_data.csv
   - {output_dir}/B_TPM/B_TPM_CHG_data.csv
   - {output_dir}/B_TPM/B_TPM_CHH_data.csv

3. total_TPM
   - {output_dir}/total_TPM/total_TPM_snp_data.csv
   - {output_dir}/total_TPM/total_TPM_CG_data.csv
   - {output_dir}/total_TPM/total_TPM_CHG_data.csv
   - {output_dir}/total_TPM/total_TPM_CHH_data.csv

4. A_per_TPM
   - {output_dir}/A_per_TPM/A_per_TPM_snp_data.csv
   - {output_dir}/A_per_TPM/A_per_TPM_CG_data.csv
   - {output_dir}/A_per_TPM/A_per_TPM_CHG_data.csv
   - {output_dir}/A_per_TPM/A_per_TPM_CHH_data.csv

5. B_per_TPM
   - {output_dir}/B_per_TPM/B_per_TPM_snp_data.csv
   - {output_dir}/B_per_TPM/B_per_TPM_CG_data.csv
   - {output_dir}/B_per_TPM/B_per_TPM_CHG_data.csv
   - {output_dir}/B_per_TPM/B_per_TPM_CHH_data.csv
