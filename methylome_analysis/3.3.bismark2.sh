...
parallel -j 4 process_fastq ::: $(find Abnormal_me Normal_me -name "*_1.fit.fastq.gz" | sed -n '301,353p')	
parallel -j 4 process_fastq ::: $(find Normal_me -name "*.fit.fastq.gz" | grep -v -E "_1|_2" | sed -n '1,250p')
